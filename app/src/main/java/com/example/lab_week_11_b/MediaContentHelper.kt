...
class MediaContentHelper {
    ...
    // Mendapatkan URI untuk menyimpan gambar di MediaStore.
    // URI akan berbeda untuk Android 10 (Q) ke atas.
    ...
    // Mendapatkan URI untuk menyimpan video di MediaStore.
    // URI akan berbeda untuk Android 10 (Q) ke atas.
    ...
    // Menghasilkan ContentValues untuk menyimpan gambar di MediaStore.
    // Ini berisi nama, path relatif, dan tipe MIME dari file.
    ...
    // Menghasilkan ContentValues untuk menyimpan video di MediaStore.
    // Ini berisi nama, path relatif, dan tipe MIME dari file.
